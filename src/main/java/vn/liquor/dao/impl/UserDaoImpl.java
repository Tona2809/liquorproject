...
public class UserDaoImpl implements UserDao {
	...
	public void editdetail(AccountDetailModel user) {
		String sql = "UPDATE Userinfo SET fullName=?, CMND=?, phoneNumber=?, fullAddress=?, imageLink=? WHERE userId = ?";
		try {
			conn = new DBConnect().getConnection();
	...
	public void editdetailimage(AccountDetailModel user) {
		String sql = "UPDATE Userinfo SET imageLink=? WHERE userId = ?";
		try {
			conn = new DBConnect().getConnection();
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public void adddetail(AccountDetailModel user) {
		String sql = "INSERT INTO Userinfo (userId, fullName, CMND, phoneNumber, fullAddress, imageLink) VALUES (?,?,?,?,?,?)";
		try {
			conn = new DBConnect().getConnection();
			PreparedStatement ps = conn.prepareStatement(sql);
